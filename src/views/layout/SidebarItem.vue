        ...
        <template>
           ...
           <!--  <router-link  to="/index/readme"  v-if="routes['/index/readme']" >
            ...
            <router-link  to="/listusers" >
                <el-menu-item index="/listusers">
                    <i class="fa fa-home" aria-hidden="true"></i> 用户管理
                </el-menu-item>
            </router-link>

            <router-link  to="/uploadtest" >
                <el-menu-item index="/uploadtest">
                    <i class="fa fa-home" aria-hidden="true"></i> 上传测试
                </el-menu-item>
            </router-link>

            <router-link to="/bangumilist">
                <el-menu-item index="/bangumilist">
                    <i class="fa fa-home" aria-hidden="true"></i> 番剧信息
                </el-menu-item>
            </router-link>
