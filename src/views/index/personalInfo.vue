        ...
        <el-row :gutter="20">
            <el-col :span="8">
                ...
                <div class="user_img" >
                    ...
                    <img v-else src="../../assets/img/zm.jpg" alt="用户头像" >
                    ...
                    <div class="user_info_form" v-if="editable">
                        ...
                        <el-form label-position="right" label-width="100px" :model="personalInfo">
                              ...
                              <el-form-item label="昵称">
                                <el-input v-model="personalInfo.nick"></el-input>
                              </el-form-item>
...
<el-row>
  <el-col>
    <el-card :body-style="{ padding: '0px' }">
      <div style="padding: 14px;">
        <span>当前总用户数：{{sysMainInfo.totalUsers}}</span>
  ...
  <el-col>
    <el-card :body-style="{ padding: '0px' }">
      <div style="padding: 14px;">
        <span>今天注册的用户数：{{sysMainInfo.newUsers}}</span>
      </div>
    </el-card>
  </el-col>
  ...
  <el-col>
    <el-card :body-style="{ padding: '0px' }">
      <div style="padding: 14px;">
        <span>当前在线游客：{{sysMainInfo.anonOnline}}</span>
      </div>
    </el-card>
  </el-col>
  ...
  <el-col>
    <el-card :body-style="{ padding: '0px' }">
      <div style="padding: 14px;">
        <span>当前在线正式用户：{{sysMainInfo.authOnline}}</span>
      </div>
    </el-card>
  </el-col>
  ...
  <el-col>
    <el-card :body-style="{ padding: '0px' }">
      <div style="padding: 14px;">
        <span>当前总在线用户：{{sysMainInfo.totalOnline}}</span>
      </div>
    </el-card>
  </el-col>
  ...
  <el-col>
    <el-card :body-style="{ padding: '0px' }">
      <div style="padding: 14px;">
        <span>总访问次数：{{sysMainInfo.visit}}</span>
      </div>
    </el-card>
  </el-col>
  ...
  <el-col>
    <el-card :body-style="{ padding: '0px' }">
      <div style="padding: 14px;">
        <span>新评论：{{sysMainInfo.newReplies}}</span>
      </div>
    </el-card>
  </el-col>
  ...
  <el-col>
    <el-card :body-style="{ padding: '0px' }">
      <div style="padding: 14px;">
        <span>今日总访客：{{sysMainInfo.totalVisitors}}</span>
      </div>
    </el-card>
  </el-col>
</el-row>
...
export default {
  ...
  methods: {
    ...
    async getUserInfo(uid) {
      let res = await adminApi.getUserInfoById(uid);
      let rd = res.data;
      if (rd.code === 0) {
        return rd.data;
      } else {
    ...
    async getSysMainInfo() {
      let res = await adminApi.getSysMainInfo();
      let rd = res.data;
      if (rd.code === 0) {
        console.log("sysInfo:", rd.data);
        this.sysMainInfo = rd.data;
        // this.$nextTick(() => {
        //   let myChart2 = echarts.init(document.getElementById("interest"));
        //   myChart2.setOption({
        //     title: { text: "站点数据" },
        //     series: [
        //       {
        ...
        //         radius: "55%",
        //         data: [
        //           { value: this.sysMainInfo.totalUsers, name: "当前总用户数" },
        //           {
        //             value: this.sysMainInfo.newUsers,
        //             name: "今天注册的用户数"
        //           },
        //           { value: this.sysMainInfo.anonOnline, name: "当前在线游客" },
        //           {
        //             value: this.sysMainInfo.authOnline,
        //             name: "在线注册注册用户"
        //           },
        //           { value: this.sysMainInfo.totalOnline, name: "当前在线用户" },
        //           { value: this.sysMainInfo.visit, name: "总访问人数" },
        //           { value: this.sysMainInfo.newReplies, name: "新评论" },
        //           { value: this.sysMainInfo.totalVisitors, name: "今日总访客" }
        //         ]
        //       }
        //     ]
        //   });
